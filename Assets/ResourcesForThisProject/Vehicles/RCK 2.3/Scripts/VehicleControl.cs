...
public enum ControlMode { simple = 1, touch = 2, train = 3 }
...
public class VehicleControl : MonoBehaviour
{
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    [HideInInspector]
    public DataLoader carInputData;
    [HideInInspector]
    ...
    void Awake()
    {
        ...
        carInputData = transform.GetComponent<DataLoader>();
    ...
    void FixedUpdate()
    {
        ...
        if (activeControl)
        {
            ...
            //input for MLAgent script
            else if(controlMode == ControlMode.train)
            {
                steer = Mathf.MoveTowards(steer, carInputData.steer, 0.2f);
                accel = carInputData.accel;
                brake = carInputData.brake;
                shift = false;
            }
